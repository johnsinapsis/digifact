                  ...
                  <div class="item">
                    ...
                    <p class="message">
                      ...
                      <span class="name">
                        ...
                        Liquidación de productos / Facturas 
                      ...
                      <div id="formresol">
                          ...
                          <input id="resol" type="hidden" name="resol" value="{{ $idsel }}"/>
                           ...
                           <div class="form-group">
                            ...
                            <div class="form-group">
                              <label class="col-md-4 control-label" >Producto / Servicio:</label>
                                <div class="input-group input-group-sm">
                ...
                <div class="box-body">
                  <ul class="todo-list">
                    ...
                    <li>
                      ...
                      <!-- todo text -->
                      <span class="text" style="font-size: 12px;">Factura: <strong>{{$fact->prefijo}} {{$fact->numfac}}</strong>. Nit: {{$fact->COD_ENT}}. {{$fact->NOM_ENT}}. Total: $ {{number_format($fact->total)}}</span>
                      <!-- Emphasis label -->
                      @if($fact->estfac==1)
